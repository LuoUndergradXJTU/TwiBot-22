...
class BotRGCN(nn.Module):
    def __init__(self,des_size=768,tweet_size=768,num_prop_size=5,cat_prop_size=3,embedding_dimension=16,dropout=0.3):
        ...
        self.rgcn=GATConv(embedding_dimension,embedding_dimension)
