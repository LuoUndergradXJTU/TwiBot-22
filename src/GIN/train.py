...
with warnings.catch_warnings():
    import torch
    # from model import GIN_classifier, GIN_classifier_1_layer, GIN_classifier_3_layer, GIN_classifier_4_layer, GIN_classifier_5_layer, GIN_classifier_6_layer, GIN_classifier_7_layer, GIN_classifier_8_layer
...
class homo_Trainer:
    def __init__(
        ...
        self.model = GIN(in_channels = input_dim,
                         hidden_channels=hidden_dim,
                         num_layers = num_hidden_layers,
                         out_channels = 2,
                         act = self.activation)
        # if num_hidden_layers == 1:
        #     self.model = GIN(input_dim, 2, hidden_dim, activation)
        ...
        #     self.model = GIN_classifier_6_layer(input_dim, 2, hidden_dim, activation)
        # elif num_hidden_layers == 7:
        #     self.model = GIN_classifier_7_layer(input_dim, 2, hidden_dim, activation)
        # elif num_hidden_layers == 8:
        #     self.model = GIN_classifier_8_layer(input_dim, 2, hidden_dim, activation)
