...
feature_extract=pipeline('feature-extraction',model=model,tokenizer=tokenizer,device=2,padding=True, truncation=True,max_length=50, add_special_tokens = True)
