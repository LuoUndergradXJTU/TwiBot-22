...
if __name__ == '__main__':
    ...
    df = pd.read_csv("/data2/whr/czl/TwiBot22-baselines/datasets/midterm-2018/label.csv")
    ...
    with open('/data2/whr/czl/TwiBot22-baselines/datasets/midterm-2018/node.json') as f:
