...
if __name__ == '__main__':
    ...
    df = pd.read_csv("/data2/whr/czl/TwiBot22-baselines/datasets/cresci-rtbust-2019/label.csv")
    ...
    with open('/data2/whr/czl/TwiBot22-baselines/datasets/cresci-rtbust-2019/node.json') as f:
