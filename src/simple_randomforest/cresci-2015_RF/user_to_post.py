...
labels = pd.read_csv("/data2/whr/czl/TwiBot22-baselines/datasets/cresci-2015/label.csv")
user_final = []
for row in labels.iterrows():
    user_final.append(row[1][0])

df = pd.read_csv("/data2/whr/czl/TwiBot22-baselines/datasets/cresci-2015/edge.csv")
user_to_post = {}
