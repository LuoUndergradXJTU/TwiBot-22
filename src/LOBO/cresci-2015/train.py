...
for random_seed in tqdm([100,200,300,400,500], 'Training and testing repeatedly for 5 times'):
    clf = RandomForestClassifier(max_depth=8, criterion='entropy', random_state=random_seed)
