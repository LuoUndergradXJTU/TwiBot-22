...
# feature_extract=pipeline'feature-extraction',model='roberta-base',tokenizer='roberta-base',device=4,padding=True, truncation=True,max_length=50, add_special_tokens = True)
        ...
        if True:
            ...
            for k,each in enumerate(tqdm(user_text)):
                ...
                if k%10000==0 and k!=0:
                    ...
                    torch.save(des_tensor,"/data2/whr/czl/TwiBot22-baselines/data/twibot22/"+file_name)
                    des_vec=[]
