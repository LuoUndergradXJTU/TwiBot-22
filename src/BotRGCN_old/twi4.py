...
feature_extract=pipeline('feature-extraction',model='roberta-base',tokenizer='roberta-base',device=6,padding=True, truncation=True,max_length=50, add_special_tokens = True)
