...
graph, uid_to_user_index, tid_to_tweet_index, train_uid_with_label, valid_uid_with_label, test_uid_with_label = hetero_graph_vectorize(include_node_feature=True, dataset="cresci-2015", server_id="209")
