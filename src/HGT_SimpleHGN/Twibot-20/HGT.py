...
class HGTDetector(pl.LightningModule):
    def __init__(self, args):
        ...
        edge_index = torch.load(args.path + "edge_index.pt", map_location="cuda")
        edge_type = torch.load(args.path + "edge_type.pt", map_location="cuda").long()
...
parser.add_argument("--path", type=str, default="/data2/whr/czl/TwiBot22-baselines/src/RGT/Twibot-20/", help="dataset path")
