...
def get_properties():
    ...
    with open(osp.join(path, 'user.json')) as f:
        ...
        for user in tqdm(users, ncols=0):
            ...
            for item in properties_segments:
                ...
                if prop is None:
                    ...
                    user_property.append(calc_activate_days(prop))
...
def get_tweet_corpus():
    ...
    for i in range(9):
        ...
        with open(osp.join(path, 'tweet_{}.json'.format(i))) as f:
...
def get_word2vec_model():
    ...
    model = word2vec.Word2Vec(sentences, vector_size=128, workers=8, min_count=15)
    ...
    for i in range(9):
        ...
        with open(osp.join(path, 'tweet_{}.json'.format(i))) as f:
            ...
            for item in data:
                ...
                tweets_index['u{}'.format(item['author_id'])].append(tweet)
                pbar.update()
