...
for choose in chooses:
        for i in range(1):
                ...
                path = "/data2/whr/zqy/preprocess_data/" + choose + "0.01test.json"
               ...
               # X = df.drop(columns=["id_x", "label","index_x","index_y","public_metrics","text"], axis=1)
                X = df.drop(columns=["id_x"], axis=1)
                y = df[["split","label"]]
